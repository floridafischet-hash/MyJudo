...
export class ChatController {
  ...
  sendVoice(
    ...
    return this.chats.sendVoice(request.user, id, file, durationMs, replyToId);
  }
  ...
  async voice(
    ...
    const audio = await this.chats.voice(request.user, id, messageId);
  ...
  async avatar(
    ...
    const image = await this.chats.chatAvatar(request.user, id);
  ...
  deleteChat(
    ...
    return this.chats.deleteChat(request.user, id);
  }
