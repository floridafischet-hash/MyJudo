...
Mitgliederverwaltung, persistente Gruppen- und Direktchats sowie die
gruppenbasierte Trainings- und Anwesenheitsverwaltung für Kodokan Osterholz.
...
- Die initialen Gruppen und Trainingszeiten werden idempotent durch `npm run
  seed --workspace @myjudo/api` angelegt und bleiben danach über die
